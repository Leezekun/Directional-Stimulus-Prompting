...
from rl4lms.envs.text_generation.test_datapool import TestTextGenPool, CNNDailyMailHint, MultiWOZHint
...
class DataPoolRegistry:
    _registry = {
        "cnn_daily_mail_with_hint": CNNDailyMailHint, # my datapool for summarization
        "multiwoz_hint": MultiWOZHint, # my datapool for multiwoz
